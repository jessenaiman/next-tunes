    ...
    return (
      <Layout>
        <Card className="bg-dark text-white">
          <Card.Img src="static/images/artshow/jesse-garden023.jpg" alt="Card image" />
          <Card.ImgOverlay>
        ...
        <Paper className="paper" elevation={1}>
          <CardDeck>
            <Card>
              <Card.Img variant="top" src="static/images/ArtShow/curtis-dancers011-8x10.jpg" />
              <Card.Body>
            ...
            <Card>
              <Card.Img variant="top" src="static/images/ArtShow/curtis skateboarder012.jpg" />
              <Card.Body>
            ...
            <Card>
              <Card.Img variant="top" src="static/images/ArtShow/edward-stringart-10x8.jpg" />
              <Card.Body>
